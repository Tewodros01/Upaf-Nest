...
export class MissionsService {
  ...
  async getStreak(userId: string) {
    try {
      const recentActivity = await this.prisma.userMission.findMany({
      ...
      const days = new Set(
        recentActivity
          ...
          .map((a) => a.claimedAt!.toDateString()),
      );
      let streak = 0;
    ...
    const missions = [
      {
        ...
        desc: 'Finish any course lesson today',
        reward: 50,
        total: 1,
      ...
      },
      {
        ...
        total: 1,
        type: MissionType.DAILY,
        category: MissionCategory.INVITE,
        icon: '👥',
        resetAt: this.getNextResetAt(MissionType.DAILY),
      },
      {
        ...
        total: 1,
        type: MissionType.DAILY,
        category: MissionCategory.DEPOSIT,
        icon: '💳',
        resetAt: this.getNextResetAt(MissionType.DAILY),
      },
      {
        title: 'Submit a Project',
        desc: 'Publish a project to your portfolio',
        reward: 300,
        total: 1,
      ...
      },
      {
        ...
        desc: 'Submit an entry to any competition',
        reward: 400,
        total: 1,
        type: MissionType.WEEKLY,
      ...
      },
      {
        ...
        desc: 'Schedule a session with a mentor',
        reward: 500,
        total: 1,
        type: MissionType.WEEKLY,
        category: MissionCategory.MENTOR,
        icon: '🎓',
        resetAt: this.getNextResetAt(MissionType.WEEKLY),
      },
      {
        title: 'Apply for a Job',
        desc: 'Submit an application this week',
        reward: 300,
        total: 1,
        type: MissionType.WEEKLY,
        category: MissionCategory.APPLY_JOB,
        icon: '💼',
        resetAt: this.getNextResetAt(MissionType.WEEKLY),
      },
      {
