        ...
        <div className="relative overflow-hidden px-5 pt-6 pb-4">
          ...
          <div className="relative flex items-center gap-4">
            <div className="relative shrink-0">
              {getPublicAssetUrl(user.avatar) ? (
                <img
                  src={getPublicAssetUrl(user.avatar) ?? undefined}
                  alt={user.username}
                  className="w-16 h-16 rounded-2xl object-cover ring-2 ring-violet-500/40 shadow-[0_0_20px_rgba(139,92,246,0.2)]"
                />
              ) : (
                <div className="w-16 h-16 rounded-2xl bg-white/8 ring-2 ring-violet-500/40 shadow-[0_0_20px_rgba(139,92,246,0.2)] flex items-center justify-center text-white text-lg font-black">
