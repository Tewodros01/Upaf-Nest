                ...
                return (
                  ...
                  >
                    <button
                      ...
                      title={n.read ? n.title : "Mark as read"}
                      onClick={() => {
                        if (!n.read) {
                          markRead(n.id);
                          haptic.light();
                    ...
                    >
                      <div
                        className={`w-10 h-10 rounded-xl border flex items-center justify-center ${meta.bg}`}
                      >
                    ...
                    >
                      <div className="flex items-center justify-between gap-2 mb-0.5">
                        <p
                          className={`text-sm font-bold truncate ${n.read ? "text-gray-300" : "text-white"}`}
                        >
                          {n.title}
                        </p>
                        {!n.read && (
