...
import { useAdminApproveDeposit, useAdminDeposits, useAdminRejectDeposit } from "./hooks";
...
import ReviewSearchBar from "../payments/components/ReviewSearchBar";
          ...
          filtered.map((item: AdminDeposit) => {
            return (
              <DepositReviewCard
                ...
                onReject={(id) =>
                  handleAction(
                    (depositId, opts) => rejectDeposit(depositId, opts),
                    id,
                  )
                }
                onApprove={(id) =>
                  handleAction(
                    (depositId, opts) => approveDeposit(depositId, opts),
                    id,
                  )
                }
              />
