...
import { FaChartLine, FaCoins, FaBook, FaTrophy } from "react-icons/fa";
import {
  FiActivity,
  FiArrowLeft,
  FiChevronRight,
...
import { useAdminDeposits, useAdminWithdrawals, useAllUsers } from "./hooks";
import type {
  AdminDeposit,
  AdminQuickAction,
  AdminStatCard,
...
export default function AdminPanel() {
  ...
  const instructors = users.filter((u: User) => u.role === "INSTRUCTOR");
              ...
              {(
                [
                  ...
                  },
                  {
                    label: "Withdrawals",
                    sub: `${pendingWithdrawals.length} pending`,
                    icon: <FiDollarSign className="text-orange-400 text-lg" />,
                  ...
                  },
                  {
                    ...
                    sub: `${instructors.length} instructors`,
                    icon: <FaBook className="text-cyan-400 text-lg" />,
                  ...
                  },
                  {
                    ...
                    icon: <FiTarget className="text-rose-400 text-lg" />,
                  ...
                  >
                    <div className="relative shrink-0">
                      {getPublicAssetUrl(u.avatar) ? (
                        ...
                        <div className="w-10 h-10 rounded-full bg-white/8 ring-2 ring-emerald-500/30 flex items-center justify-center text-white text-xs font-black">
