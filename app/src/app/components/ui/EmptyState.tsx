...
export default function EmptyState({ type = "games", title, subtitle, action }: EmptyStateProps) {
  return (
    <motion.div
    ...
    >
      ...
      {action && (
        <button type="button" onClick={action.onClick}
          className="mt-1 px-5 py-2.5 text-xs font-bold rounded-xl active:scale-95 transition-all text-emerald-400"
